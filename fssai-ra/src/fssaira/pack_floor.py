...
* identity, health, support, and financial classes never reach an external zone;
...
def load_governed_pack(path: str | Path, *, floor: bool = True) -> GovernedPack:

...
Past some length nobody can answer the student's question of who decided.
...
class DelegationCode:
    ...
    and :class:`fssaira.oversight.OversightCode`: tests, metrics, and the
...
class DelegationPolicy:
    ...
    Like :class:`fssaira.oversight.ReviewLoadPolicy`, these are deployment
...
class DelegationAuthority:
    ...
    def admit(
        ...
        *,
        ...
        Raises :class:`~fssaira.exact_action.ExecutionDenied` on refusal, so an
...
def verify_delegation_space(
    ...
    *,
    ...
    root = RootGrant("root-principal", root_scope, "student_services", now + 10_000.0)

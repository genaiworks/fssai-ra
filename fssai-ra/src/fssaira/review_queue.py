...
:mod:`fssaira.oversight` bounds what one reviewer may approve. This module governs
...
what that common default does. Domain packs cannot select it (:mod:`fssaira.pack_floor`

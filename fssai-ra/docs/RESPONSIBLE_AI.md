...
| **Rubber-stamping: the reviewer approves without reading** | **Not mitigated.** Binding an approval to an exact proposal prevents *reuse*; it cannot make a person read | — | **Open. Unmeasured.** Reviewer accuracy and workload are on the not-yet-evidenced list, and no claim is made about them |

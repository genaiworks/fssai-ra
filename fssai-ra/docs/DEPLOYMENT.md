...
| `no_model_holds_a_key` | The bind stage |
| `falsifiers_zero_counterexamples`, `ablations_restore_harm` | Thesis and education falsifiers with a positive control; control ablation |

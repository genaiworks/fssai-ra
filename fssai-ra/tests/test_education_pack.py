...
Each test named in ``conference/education/governed-learning-pack.yaml`` lives here.
...
from fssaira.disclosure import DataLabel, DisclosureDenied
from fssaira.education_models import MaliciousAssistant, MaliciousRouter
from fssaira.education_world import (
    ALL_CONTROLS,
    NOW,
    STUDENTS,
    EducationWorld,
)
from fssaira.evidence_notary import rewrite_history, verify_receipt
from fssaira.exact_action import Approval, ExecutionDenied
from fssaira.model_registry import ModelAttestationDenied
from fssaira.pack_floor import FloorCode, PackRejected, check_pack, load_governed_pack, read_pack
from fssaira.review_queue import ReviewRefused, ReviewState

MALICIOUS_PACK = "conference/attacks/malicious-domain-pack.yaml"
PACK = "conference/education/governed-learning-pack.yaml"

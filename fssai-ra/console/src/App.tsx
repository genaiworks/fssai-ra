  ...
  return (
    <div className="shell">
      ...
      <footer className="bottom">
        Apache-2.0 · Companion to <em>Trust by Construction: A Cross-Sector Reference
        Architecture for Governed Agentic AI</em> · Results shown here are fixture observations in a declared

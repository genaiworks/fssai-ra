...
- Attach `docs/TECHNICAL_NOTE.md` as the technical handout if the form accepts supporting material; it links the evidence-plane walkthrough and `docs/TOOLING_RATIONALE.md`, which justifies Kafka, Spark, Iceberg, Redis and Ollama tool by tool and prepares the Q&A answers.

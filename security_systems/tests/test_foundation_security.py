...
from trustkernel.kernel.evidence_notary import EvidenceNotary
from trustkernel.kernel.model_registry import (
    ManifestPublisher,
...
def test_expiry_is_enforced_when_caller_omits_time(monkeypatch):
    ...
    monkeypatch.setattr("trustkernel.kernel.model_registry.time.time", lambda: 101.0)
...
def test_erasure_does_not_claim_complete_when_evidence_is_missing(statuses):
    from trustkernel.kernel.privacy_pipeline import ErasureVerification, LocationCheck

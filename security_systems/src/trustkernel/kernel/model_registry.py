...
ablatable control, ``model_attestation``, in the privacy checks,
deliberately *not* in :data:`trustkernel.kernel.disclosure.ALL_CHECKS`: the disclosure
...
def _ed25519():
    try:
        ...
        raise RuntimeError(
            "model attestation needs the 'cryptography' package: pip install trustkernel"
        ) from exc
